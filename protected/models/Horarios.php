...
class Horarios extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nombre, fin, inicio, dias_semana, horas_semanales', 'required'),
			array('id, dias_semana, horas_semanales', 'numerical', 'integerOnly'=>true),
			array('nombre', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nombre, fin, inicio, dias_semana, horas_semanales', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'contratoses' => array(self::HAS_MANY, 'Contratos', 'horario'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('dias_semana',$this->dias_semana);
