...
$mPDF1->SetTitle("Reporte - TipoContrato");
...
$mPDF1->Output('Reporte - TipoContrato '.date('YmdHis'),'I');  //Nombre del pdf y parámetro para ver pdf o descargarlo directamente.
exit;
}
