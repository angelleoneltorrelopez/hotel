...
{
$dataProvider=new CActiveDataProvider('Disponibilidad');
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='disponibilidad-form')
{
...
$mPDF1->SetTitle("Reporte - Disponibilidad");
...
$mPDF1->Output('Reporte - Disponibilidad '.date('YmdHis'),'I');  //Nombre del pdf y parámetro para ver pdf o descargarlo directamente.
exit;
}
