...
'actions'=>array('index','view','create','admin','update','delete','generarpdf','authsigned'),
'roles'=>array('gerente','jefe_mant','enc_edif'),
),
...
{
$model->attributes=$_POST['Mantenimiento'];
if($model->save())
...
$model->attributes=$_GET['Mantenimiento'];
...
{
$model=Mantenimiento::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='mantenimiento-form')
{
...
$mPDF1->SetTitle("Reporte - Mantenimiento");
...
$mPDF1->Output('Reporte - Mantenimiento '.date('YmdHis'),'I');  //Nombre del pdf y parámetro para ver pdf o descargarlo directamente.
exit;
}
