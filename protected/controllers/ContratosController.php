...
'actions'=>array('index','view','admin','generarpdf'),
'roles'=>array('recep'),
),
array('allow', // allow authenticated user to perform 'create' and 'update' actions
'actions'=>array('index','view', 'create','admin','update','delete','authsigned','generarpdf'),
...
$mPDF1->SetTitle("Reporte - Contratos");
...
$mPDF1->Output('Reporte - Contratos '.date('YmdHis'),'I');  //Nombre del pdf y parámetro para ver pdf o descargarlo directamente.
exit;
}
