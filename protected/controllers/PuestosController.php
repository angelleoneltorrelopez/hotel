...
$mPDF1->SetTitle("Reporte - Puestos");
...
$mPDF1->Output('Reporte - Puestos '.date('YmdHis'),'I');  //Nombre del pdf y parámetro para ver pdf o descargarlo directamente.
exit;
}
