...
$mPDF1->SetTitle("Reporte - Empleados");
...
$mPDF1->Output('Reporte - Empleados '.date('YmdHis'),'I');  //Nombre del pdf y parámetro para ver pdf o descargarlo directamente.
exit;
}
