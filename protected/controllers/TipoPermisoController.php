...
{
$model->attributes=$_POST['TipoPermiso'];
if($model->save())
...
{
$dataProvider=new CActiveDataProvider('TipoPermiso');
...
{
$model=new TipoPermiso('search');
$model->unsetAttributes();  // clear any default values
if(isset($_GET['TipoPermiso']))
$model->attributes=$_GET['TipoPermiso'];
...
{
$model=TipoPermiso::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='tipo-permiso-form')
{
...
$mPDF1->SetTitle("Reporte - TipoPermiso");
...
$mPDF1->Output('Reporte - TipoPermiso '.date('YmdHis'),'I');  //Nombre del pdf y parámetro para ver pdf o descargarlo directamente.
exit;
}
