...
$mPDF1->SetTitle("Reporte - Horarios");
...
$mPDF1->Output('Reporte - Horarios '.date('YmdHis'),'I');  //Nombre del pdf y parámetro para ver pdf o descargarlo directamente.
exit;
}
