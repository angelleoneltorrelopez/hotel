...
{
$model=new SolicitudPermiso('search');
$model->unsetAttributes();  // clear any default values
if(isset($_GET['SolicitudPermiso']))
$model->attributes=$_GET['SolicitudPermiso'];
...
if(isset($_POST['SolicitudPermiso']))
{
$model->attributes=$_POST['SolicitudPermiso'];
if($model->save())
...
$model->cantidad_dias=round($diferencia / 86400); // En días
...
{
$dataProvider=new CActiveDataProvider('SolicitudPermiso');
...
{
$model=SolicitudPermiso::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='solicitud-permiso-form')
{
...
$mPDF1->SetTitle("Reporte - SolicitudPermiso");
...
$mPDF1->Output('Reporte - SolicitudPermiso '.date('YmdHis'),'I');  //Nombre del pdf y parámetro para ver pdf o descargarlo directamente.
exit;
}
