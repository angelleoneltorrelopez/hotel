...
if($model->save())
$this->redirect(array('view','id'=>$model->id_tipo_habitacion));
}
...
$mPDF1->SetTitle("Reporte - TipoHabitacion");
...
$mPDF1->Output('Reporte - TipoHabitacion '.date('YmdHis'),'I');  //Nombre del pdf y parámetro para ver pdf o descargarlo directamente.
exit;
}
