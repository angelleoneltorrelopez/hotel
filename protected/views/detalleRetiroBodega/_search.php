<?php $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
	...
	'method'=>'get',
		...
		<?php echo $form->textFieldGroup($model,'id_detalle_retiro_bodega',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>
		...
		<?php echo $form->textFieldGroup($model,'fecha_retiro',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>
