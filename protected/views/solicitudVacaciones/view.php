...
array('label'=>'Borrar Solicitud Vacaciones','icon'=>'remove-sign','url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$model->id),
'confirm'=>'¿Seguro que quieres eliminar este elemento?'),'visible'=>Yii::app()->user->checkAccess("recep")
|| Yii::app()->user->checkAccess("gerente")),

array('label'=>'Actualizar Solicitud Vacaciones','icon'=>'refresh','url'=>array('update','id'=>$model->id),
...
<h1>Vista Solicitud de Vacaciones #<?php echo $model->id; ?></h1>
