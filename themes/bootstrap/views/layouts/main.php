 ...
 'items'=>array(
   ...
   Yii::app()->user->checkAccess("recep")),
      ...
      array('label'=>'Contratos', 'items'=>array(
        ...
        array('label'=>'Jornadas', 'url'=>array('/horarios/admin'),'visible'=>Yii::app()->user->checkAccess("jefe_RRHH")),
        array('label'=>'Jornadas', 'url'=>array('/horarios/admin'),'visible'=>Yii::app()->user->checkAccess("recep")),
        array('label'=>'Jornadas', 'url'=>array('/horarios/admin'),'visible'=>Yii::app()->user->checkAccess("gerente")),
